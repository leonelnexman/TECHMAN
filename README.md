...
В корень папки sass добавлять только те файлы, которые должны получиться на выходе, если должен быть на выходе тольео 1 файл - то добавить только 1 и внутри него подключить все остальные файлы стилей, которые расположить в поддиректориях этой папки

С папкой js - то же самое, в корне главные файлы, внутри них подключаются другие файлы из под-папок
